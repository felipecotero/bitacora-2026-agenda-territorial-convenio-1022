...
const CRONOGRAMA = [
  ...
  },
  {
    ...
    detalle: 'Felipe envía a Mercy y Jeimmy el documento que detalla el contenido de las sesiones del 15 de mayo y el 28 de mayo.',
    responsables: ['felipe'],
    tipo: 'entrega', estado: 'pendiente',
  },
  {
...
const CICLO = [
  ...
  { n: 3,  fecha: '2026-05-19', dia: 'Martes',    hora: '10:00–11:30', orient: 'jeimmy', tipo: 'Saberes RIJ',          tema: 'Contexto: curar el entorno',                              estado: 'hecha', estadoCal: 'confirmado', alerta: 'Lunes 18 festivo → martes 10:00', enlaceSesion: '', enlaceGrabacion: 'https://mcultura-my.sharepoint.com/:v:/g/personal/agendaterritorial_mincultura_gov_co/IQAAUgxBIH-pRIOZgvOjIShuAdPaONFi4S3T2Zp5sDugqE8?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=QgMaJf', enlacePuntoControl: 'https://forms.gle/6zsR6KiiZjMkkg3A9' },
  { n: 4,  fecha: '2026-05-20', dia: 'Miércoles', hora: '18:30–20:00', orient: 'mercy',  tipo: 'Saberes financieros', tema: 'Presupuesto',                                               estado: 'hecha', estadoCal: 'confirmado', enlaceSesion: '', enlaceGrabacion: 'https://mcultura-my.sharepoint.com/:v:/g/personal/agendaterritorial_mincultura_gov_co/IQBKxwj3f86QQqY6ECgk4M-9ASZMLoZ6JEqFlkERaUYOrOs?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=sHuWfT', enlacePuntoControl: 'https://forms.cloud.microsoft/r/N25UJDhn4H?origin=lprLink' },
  { n: 5,  fecha: '2026-05-28', dia: 'Jueves',    hora: '18:30–20:00', orient: 'felipe', tipo: 'Comunicaciones',       tema: 'Decidir qué se dice y qué se cuida — Comunicaciones 2',   estado: 'hecha', estadoCal: 'confirmado', enlaceSesion: '', enlaceGrabacion: 'https://mcultura-my.sharepoint.com/:v:/g/personal/agendaterritorial_mincultura_gov_co/IQALgc280ekJS6P3E1KxcqSiAUTTo6pKCirrRFOGTMlH1io?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=FSFYgc', enlacePuntoControl: 'https://forms.cloud.microsoft/r/gweNZFUbxu' },
  { n: 6,  fecha: '2026-05-25', dia: 'Lunes',     hora: '18:30–20:00', orient: 'jeimmy', tipo: 'Saberes RIJ',          tema: 'Reciprocidad: la ética de la corresponsabilidad',          estado: 'hecha', estadoCal: 'confirmado', enlaceSesion: '', enlaceGrabacion: 'https://mcultura-my.sharepoint.com/:v:/g/personal/agendaterritorial_mincultura_gov_co/IQAYKXA1ZYL-Sq4TMj8WJECdASfG25FqMKNPrnaGtltrs0E?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=09ks2e', enlacePuntoControl: 'https://docs.google.com/forms/d/e/1FAIpQLSecsjwcArzuJTag4yjceOXYiJXUm_v4TNA05MpZ1hXoredpqQ/viewform' },
  { n: 7,  fecha: '2026-05-27', dia: 'Miércoles', hora: '18:30–20:00', orient: 'mercy',  tipo: 'Saberes financieros', tema: 'Flujo de caja',                                             estado: 'hecha', estadoCal: 'confirmado', enlaceSesion: '', enlaceGrabacion: 'https://mcultura-my.sharepoint.com/:v:/g/personal/agendaterritorial_mincultura_gov_co/IQDF0Zlz6Eu-TZ_hA2K57HNQAZzMHF9FRCS3M2NASZHMvgM?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=o0bm0j', enlacePuntoControl: 'https://forms.cloud.microsoft/r/1M5V6RTpv9?origin=lprLink' },
  { n: 8,  fecha: '2026-05-29', dia: 'Viernes',   hora: '18:30–20:00', orient: 'mercy',  tipo: 'Saberes financieros', tema: 'Diversificación de ingresos',                               estado: 'hecha', estadoCal: 'confirmado', enlaceSesion: '', enlaceGrabacion: 'https://mcultura-my.sharepoint.com/:v:/g/personal/agendaterritorial_mincultura_gov_co/IQAast08TCNZRJooM5KscHw_AUE_JTR18JudzkbcTnTjeXU?nav=eyJyZWZlcnJhbEluZmEiOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=dIVwud', enlacePuntoControl: 'https://forms.cloud.microsoft/r/5WTr2en69H?origin=lprLink' },
  { n: 9,  fecha: '2026-06-01', dia: 'Lunes',     hora: '18:30–20:00', orient: 'jeimmy', tipo: 'Saberes RIJ',          tema: 'Flujo del ser: la coherencia interna',                     estado: 'hecha', estadoCal: 'confirmado', enlaceSesion: '', enlaceGrabacion: 'https://mcultura-my.sharepoint.com/:v:/g/personal/agendaterritorial_mincultura_gov_co/IQBpE9Yzt2MUT43zPCzdCWbeAXyRdCv1h3gORofyILWsNlM?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=opxPja', enlacePuntosClaves: 'https://mcultura-my.sharepoint.com/:v:/g/personal/agendaterritorial_mincultura_gov_co/IQBpE9Yzt2MUT43zPCzdCWbeAXyRdCv1h3gORofyILWsNlM?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=opxPja' },
  { n: 10, fecha: '2026-06-03', dia: 'Miércoles', hora: '18:30–20:00', orient: 'mercy',  tipo: 'Saberes financieros', tema: 'Indicadores para el control financiero',                    estado: 'hecha', estadoCal: 'confirmado', enlaceSesion: '', enlaceGrabacion: 'https://mcultura-my.sharepoint.com/:v:/g/personal/agendaterritorial_mincultura_gov_co/IQB3BrbprkF0Q79Z_N-LuLlpAa4KkqJvwNA1uh_juRr0s2g?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=h2Wjvt', enlacePuntoControl: 'https://forms.cloud.microsoft/r/Ue9tCjEvYH?origin=lprLink' },
  { n: 11, fecha: '2026-07-29', dia: 'Miércoles', hora: '17:30–19:00', orient: 'jeimmy', tipo: 'Saberes RIJ',          tema: 'Caja de herramientas 1: lo político del cuidado situado',  estado: 'pendiente', estadoCal: 'confirmado', enlaceSesion: 'https://teams.microsoft.com/l/meetup-join/19%3ameeting_N2Q4Y2Q3ZjgtOTgwZS00MGFlLWIxNDMtNjEzMDNiOTAyYWM0%40thread.v2/0?context=%7b%22Tid%22%3a%2293f28b4e-935c-4c14-88ac-e48697c1fc97%22%2c%22Oid%22%3a%22ef891193-bef0-4344-b607-27b1c4190afd%22%7d', enlaceGrabacion: '' },
  { n: 12, fecha: '2026-07-30', dia: 'Jueves',    hora: '18:30–20:00', orient: 'jeimmy', tipo: 'Saberes RIJ',          tema: 'Herramientas 2: lo político del cuidado situado',          estado: 'pendiente', estadoCal: 'confirmado', enlaceSesion: 'https://teams.microsoft.com/l/meetup-join/19%3ameeting_YzRiZDM5YmYtZTM0Ny00ZjE2LThmOTAtNTJhMzM2YzcwMzE2%40thread.v2/0?context=%7b%22Tid%22%3a%2293f28b4e-935c-4c14-88ac-e48697c1fc97%22%2c%22Oid%22%3a%22ef891193-bef0-4344-b607-27b1c4190afd%22%7d', enlaceGrabacion: '' },
];
...
const BITACORA = [
  {
    fecha: '2026-06-03', tipo: 'sintesis', autor: 'mercy',
    titulo: 'Sesión 10 del Ciclo · Indicadores para el control financiero',
    cuerpo: 'Mercy Arias orientó la décima sesión del Ciclo de Formación Puente, dedicada a indicadores de control financiero para organizaciones culturales. La sesión cerró la línea de saberes financieros con herramientas concretas para que las organizaciones puedan monitorear su salud económica: indicadores de liquidez, de ejecución presupuestal y de cobertura de gastos fijos. Se trabajó la diferencia entre registrar y controlar —llevar las cuentas no es lo mismo que leer los datos para tomar decisiones—. Las participantes identificaron cuáles indicadores son prioritarios según el tamaño y la complejidad de sus proyectos. Acuerdo de cierre de la línea: cada organización construirá su tablero mínimo de control con al menos tres indicadores propios antes del Encuentro de Cali.',
    enlaceUrl: 'https://mcultura-my.sharepoint.com/:v:/g/personal/agendaterritorial_mincultura_gov_co/IQB3BrbprkF0Q79Z_N-LuLlpAa4KkqJvwNA1uh_juRr0s2g?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=h2Wjvt',
    enlaceLabel: 'Ver grabación · Sesión 10 — Indicadores financieros',
  },
  {
    fecha: '2026-05-25', tipo: 'sintesis', autor: 'jeimmy',
    titulo: 'Sesión 6 del Ciclo · Reciprocidad: la ética de la corresponsabilidad',
    cuerpo: 'Jeimmy Ruiz orientó la sexta sesión del Ciclo, desde el enfoque de cuidado de la estrategia Puente, profundizando en la noción de reciprocidad como fundamento ético de las organizaciones comunitarias. La sesión exploró la corresponsabilidad no como un principio abstracto, sino como práctica situada: cómo se distribuyen las cargas, los cuidados y las decisiones dentro de las redes territoriales. Se trabajó la diferencia entre solidaridad reactiva —responder cuando algo falla— y corresponsabilidad sostenida —construir estructuras que previenen el agotamiento y el abandono—. Las participantes reflexionaron sobre sus propias redes y mapearon quiénes sostienen, quiénes reciben y cómo se equilibran esas relaciones en sus organizaciones. Cierre de la sesión: cada organización identifica un vínculo de reciprocidad que quiere fortalecer antes del Encuentro de Cali.',
    enlaceUrl: 'https://mcultura-my.sharepoint.com/:v:/g/personal/agendaterritorial_mincultura_gov_co/IQAYKXA1ZYL-Sq4TMj8WJECdASfG25FqMKNPrnaGtltrs0E?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=09ks2e',
    enlaceLabel: 'Ver grabación · Sesión 6 — Reciprocidad',
  },
  {
    fecha: '2026-05-20', tipo: 'sintesis', autor: 'mercy',
    titulo: 'Sesión 4 del Ciclo · Presupuesto para organizaciones culturales',
    cuerpo: 'Mercy Arias orientó la cuarta sesión del Ciclo de Formación Puente, dedicada a herramientas de presupuestación para iniciativas culturales. Partiendo de las finanzas personales —vistas en la sesión anterior—, la sesión avanzó hacia el presupuesto de proyectos y organizaciones. Se trabajaron los componentes de un presupuesto: ingresos (propios, aportes en especie, contrapartidas, subvenciones), gastos fijos y variables, y la importancia de estimar con honestidad antes de ejecutar. Un punto central fue la diferencia entre un presupuesto de proyecto —acotado en tiempo y objeto— y el presupuesto operativo de la organización. Las participantes ejercitaron la construcción de un presupuesto básico con ejemplos propios de sus iniciativas. Acuerdo de la sesión: cada organización identifica sus tres principales fuentes de ingreso actuales y sus tres gastos fijos recurrentes, como punto de partida para la próxima sesión de flujo de caja.',
    enlaceUrl: 'https://mcultura-my.sharepoint.com/:v:/g/personal/agendaterritorial_mincultura_gov_co/IQBKxwj3f86QQqY6ECgk4M-9ASZMLoZ6JEqFlkERaUYOrOs?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=sHuWfT',
    enlaceLabel: 'Ver grabación · Sesión 4 — Presupuesto',
  },
  {
    fecha: '2026-05-19', tipo: 'sintesis', autor: 'jeimmy',
    titulo: 'Sesión 3 del Ciclo · Curar el entorno — lo político del cuidado situado',
    cuerpo: 'Jeimmy Ruiz orientó la tercera sesión del Ciclo, desde el enfoque de cuidado de la estrategia Puente. La sesión desarrolló la diferencia entre "la política del cuidado" —normativa, institucional, de lineamientos— y "lo político del cuidado situado" —el hacer, el vínculo, la transformación real en el cuerpo y la comunidad—. Jeimmy presentó el marco conceptual que sostiene su investigación de 11 años: el pacto de la escucha como herramienta de organización comunitaria, la bioética del cuidado relacional, y la soberanía epistemológica de los saberes territoriales. La sesión exploró cómo las prácticas rituales y estéticas de lo común construyen lo político desde la base: redes, sistematización y modelos de gestión como canales, no como fines. Referente de la sesión: el documento "Orientaciones artístico-pedagógicas para una danza del cuidado", disponible en la sesión de Caja de herramientas al cierre del Ciclo.',
    enlaceUrl: 'https://mcultura-my.sharepoint.com/:v:/g/personal/agendaterritorial_mincultura_gov_co/IQAAUgxBIH-pRIOZgvOjIShuAdPaONFi4S3T2Zp5sDugqE8?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=QgMaJf',
    enlaceLabel: 'Ver grabación · Sesión 3 — Curar el entorno',
  },
  {
    fecha: '2026-05-15', tipo: 'sintesis', autor: 'felipe',
    titulo: 'Sesión 2 del Ciclo · Desde dónde hablamos — Comunicaciones 1',
    cuerpo: 'Felipe Camacho orientó la segunda sesión del Ciclo, con foco en la voz propia de las organizaciones. La sesión partió de una pregunta central: ¿desde qué lugar habla tu organización cuando se comunica hacia afuera? Usando una anécdota real del Convenio —una organización hostigada por la institucionalidad local que debió decidir cómo comunicar sin confrontar directamente—, se exploró la diferencia entre visibilización como protección y confrontación como riesgo. Las participantes realizaron un punto de chequeo inicial (6 preguntas sobre claridad comunicativa de su organización) y un ejercicio de plenaria para identificar palabras que son completamente propias versus vocabulario prestado o institucional. La sesión cerró con la idea de que decidir qué se dice y qué se cuida no es censura, sino política organizacional consciente.',
    enlaceUrl: 'https://mcultura-my.sharepoint.com/:v:/g/personal/agendaterritorial_mincultura_gov_co/IQBpEV526p76TrPw036-cSEnAdhb41EGjOIj3zpDWbFDzXs?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=qCLX8i',
    enlaceLabel: 'Ver grabación · Sesión 2 — Comunicaciones 1',
  },
  {
    fecha: '2026-05-13', tipo: 'sintesis', autor: 'mercy',
    titulo: 'Sesión 1 del Ciclo · Finanzas personales para artistas y gestoras',
    cuerpo: 'Mercy Arias inauguró el Ciclo de Formación Puente con una sesión de finanzas personales dirigida a artistas y gestoras culturales. Mercy —economista y bailarina— presentó las especificidades del sector: ingresos irregulares, necesidad de invertir en el arte propio, y el portafolio profesional como realidad no como opción. La sesión abrió con un ejercicio de relación emocional con el dinero y avanzó por cuatro buenas prácticas: (1) el presupuesto personal —con ingresos fijos y variables, gastos fijos y variables, y ahorro—; (2) gastar menos de lo que se gana; (3) el Fondo de Emergencia como "santo grial" financiero —equivalente a 6 meses de gastos para personas freelance—; y (4) el registro diario de todos los gastos. Mercy hizo énfasis en que organizarse personalmente es requisito previo para gestionar las finanzas de una organización. Lema de la sesión: persona, paciencia y persistencia.',
    enlaceUrl: 'https://mcultura-my.sharepoint.com/:v:/g/personal/agendaterritorial_mincultura_gov_co/IQDRTTKUfhzsQIJGYKxtS-EeAeakfJdJjbsb7CrFUNk0oCM?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=Xuk9NS',
    enlaceLabel: 'Ver grabación · Sesión 1 — Finanzas personales',
  },
  {
    fecha: '2026-05-21', tipo: 'novedad', autor: 'monica',
    titulo: 'Documento conceptual del Encuentro RIJ · en manos de la coordinación',
    cuerpo: 'El documento conceptual del Encuentro de la Red Intercultural Juvenil —Cali, 24–27 de junio— ya está en manos de Yuli y Mónica para revisión y ajustes. Mónica articuló la consolidación con aportes del equipo. Una vez revisado, pasará a Felipe para diagramación. Próximo paso: versión revisada disponible a finales de mayo.',
  },
  {
    fecha: '2026-05-21', tipo: 'novedad', autor: 'jeimmy',
    titulo: 'Primera reunión de Minga técnica · equipo RIJ',
    cuerpo: 'Se realizó la primera reunión de Minga técnica con el equipo de la Red Intercultural Juvenil. Este espacio de articulación interna del nodo RIJ es parte de la preparación para el Encuentro de Cali y para el acompañamiento a las organizaciones en la ruta de desarrollo de capacidades.',
  },
  {
    fecha: '2026-05-21', tipo: 'novedad', autor: 'mercy',
    titulo: 'Instructivo de costos y gastos · homologación colectiva pendiente',
    cuerpo: 'La socialización del instructivo de costos y gastos con las organizaciones del Convenio, realizada el 19 de mayo, fue informativa pero aún no se ha hecho la homologación colectiva en reunión plenaria. Queda pendiente convocar ese espacio para que todas las organizaciones puedan hacer preguntas, aclarar dudas sobre la liquidación de sus proyectos y alinear criterios antes del cierre de la vigencia.',
  },
  {
